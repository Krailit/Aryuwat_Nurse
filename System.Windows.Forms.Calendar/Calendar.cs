        ...
        : ScrollableControl
    {
        ...
        public Calendar()
        {
            ...
            HighlightRanges = new CalendarHighlightRange[] { 
                new CalendarHighlightRange( DayOfWeek.Monday, new TimeSpan(8,0,0), new TimeSpan(20,0,0)),
                new CalendarHighlightRange( DayOfWeek.Tuesday, new TimeSpan(8,0,0), new TimeSpan(20,0,0)),
                new CalendarHighlightRange( DayOfWeek.Wednesday, new TimeSpan(8,0,0), new TimeSpan(20,0,0)),
                new CalendarHighlightRange( DayOfWeek.Thursday, new TimeSpan(8,0,0), new TimeSpan(20,0,0)),
                new CalendarHighlightRange( DayOfWeek.Friday, new TimeSpan(8,0,0), new TimeSpan(20,0,0)),
            };

            _timeScale = CalendarTimeScale.ThirtyMinutes;
            SetViewRange(DateTime.Now, DateTime.Now.AddDays(4));
        ...
        #region Properties
        public List<BookingRoomEnt> Rooms
        {
            get;
            set;
        }
        ...
        public void SetViewRange(DateTime dateStart, DateTime dateEnd)
        {
            ...
            //_viewStart = new DateTime(dateStart.Date.Year, dateStart.Date.Month, dateStart.Date.Day,8,0,0);
            ViewEnd = dateEnd;
        }
        public void setVariable(List<BookingRoomEnt> rm)
        {
            Rooms = rm;
            //CalendarDay calendarDay = new CalendarDay(this, rname);
        }
        /// <summary>
        ...
        private void UpdateDaysAndWeeks()
        {
            ...
            for (int i = 0; i < Days.Length; i++)
            {
                Days[i] = new CalendarDay(this, ViewStart.AddDays(-preDays + i), i, Rooms);//mark
                Days[i].Rooms = Rooms;
            }
        ...
        protected virtual void OnItemMouseLeave(CalendarItemEventArgs e)
        {
        ...
        public ICalendarSelectableElement hitItem;
        protected override void OnMouseDown(MouseEventArgs e)
        {
            base.OnMouseDown(e);

            ICalendarSelectableElement hitted = hitItem = HitTest(e.Location);
            ...
            switch (State)
            {
                case CalendarState.Idle:
                    ...
                    else
                    {
                     ...
                     //   SetState(CalendarState.DraggingTimeSelection);//  drag and drop
                    }
                    break;
            ...
            if (hitted != null)
            {
                switch (State)
                {
                    case CalendarState.Idle:
                        ...
                        {
                            OnItemMouseLeave(new CalendarItemEventArgs(hittedItem));
                        }
