...
namespace System.Windows.Forms.Calendar
{
        ...
        : CalendarRenderer
    {
        ...
        public override void OnDrawDayBorder(CalendarRendererDayEventArgs e)
        {
            ...
            using (Pen p = new Pen(ColorTable.DayBorder,  1))//mark  �բͺ �ѹ���เบิก���͡
            {
        ...
        public override void OnDrawDayTop(CalendarRendererDayEventArgs e)
        {
            ...
            using (Brush b = new SolidBrush( s ? ColorTable.DayTopSelectedBackground : ColorTable.DayTopBackground))//���� header
            {
                e.Graphics.FillRectangle(b, e.Day.DayTop.Bounds);
            }

            using (Pen p = new Pen(s ? ColorTable.DayTopSelectedBorder : ColorTable.DayTopBorder))// �բͺ�� header
            {
        ...
        public override void OnDrawDayTimeUnit(CalendarRendererTimeUnitEventArgs e)
        {
            ...
            using (SolidBrush b = new SolidBrush(ColorTable.TimeUnitBackground))//�վ�鹢ͧ���ҧ �͡���ҷӧҹ
            {
                if (e.Unit.Selected)
                {
                    b.Color = ColorTable.TimeUnitSelectedBackground;// �վ��㹵��ҧ���เบิก
                }
                else if (e.Unit.Highlighted)
                {
                    //b.Color = ColorTable.TimeUnitHighlightedBackground;//�վ�鹢ͧ���ҧ����ҷӧҹ �� 8-16.00
                    b.Color = ColorTable.TimeUnitBackground;//�վ�鹢ͧ���ҧ����ҷӧҹ �� 8-16.00
                }

                e.Graphics.FillRectangle(b, e.Unit.Bounds);
            }
            
            using (Pen p = new Pen(e.Unit.Minutes == 0 ? ColorTable.TimeUnitBorderDark : ColorTable.TimeUnitBorderLight))//����� ���ҧ����
            {
        ...
        public override void OnDrawTimeScale(CalendarRendererEventArgs e)
        {
            ...
            int shortX2 = largeX2;
            int top = 0;
            Pen p = new Pen(ColorTable.TimeScaleLine);//����� timescale
        ...
        public override void OnDrawItemBackground(CalendarRendererItemBoundsEventArgs e)
        {
            ...
            Color color2 = e.Item.Selected ? ColorTable.ItemSelectedBackground : ColorTable.ItemBackground;//�� object ������ҧ���
