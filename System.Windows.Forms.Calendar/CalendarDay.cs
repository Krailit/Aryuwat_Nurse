...
namespace System.Windows.Forms.Calendar
{
        ...
        : CalendarSelectableElement
    {
        ...
        #region Fields
        public List<CalendarItem> _containedItems;
        ...
        internal CalendarDay(Calendar calendar, DateTime date, int index, List<BookingRoomEnt> rm)
            : base(calendar)
        {
        ...
        public CalendarDay(Calendar calendar,string rn)
            : base(calendar)
        {
            this.RoomName = rn;
        }
