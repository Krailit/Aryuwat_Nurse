...
{
    public partial class ButtonMerg : UserControl
    {
        public ButtonMerg()
        {
            InitializeComponent();
        ...
        {
            picTmp.Image = global::AryuwatSystem.Properties.Resources.MergN;
        }

        private void picTmp_MouseMove(object sender, MouseEventArgs e)
        {
            picTmp.Image = global::AryuwatSystem.Properties.Resources.MergO;
