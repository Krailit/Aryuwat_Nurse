...
namespace AryuwatSystem.Data
{
    ...
    {
        /// <summary>
        /// �Ѻ Query ���͹������ҧ����Ţ�ӴѺ������ٻẺ����Ţ��ǹ
        /// </summary>
        /// <param name="strSQL">Query ����٧�ش�� Select Max(ID) from MyTable</param>
        /// <returns>String �Ţ�ӴѺ����</returns>
        ...
        /// <summary>
        /// Method ����˹�ҷ��㹡�� Gen Id ����� Interger
        /// </summary>
        /// <param name="strSql">Query ����ͧ��� �� Select Max(...) From ... </param>
