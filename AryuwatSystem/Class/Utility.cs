...
namespace AryuwatSystem.DerClass
{
    public class DerUtility
    {
        ...
        {
            string monthname = "";
            if(mon==1)monthname="���Ҥ�";
            else if(mon==2)monthname="����Ҿѹ��";
            else if(mon==3)monthname="�չҤ�";
            else if(mon==4)monthname="����¹";
            else if(mon==5)monthname="����Ҥ�";
            else if(mon==6)monthname="�Զع�¹";
            else if(mon==7)monthname="�á�Ҥ�";
            else if(mon==8)monthname="�ԧ�Ҥ�";
            else if(mon==9)monthname="�ѹ��¹";
            else if(mon==10)monthname="���Ҥ�";
            else if(mon==11)monthname="��Ȩԡ�¹";
            else if(mon==12)monthname="�ѹ�Ҥ�";
        ...
        public static string FormatSysDate(DateTime dtmInput)
        {
            ...
            dtfInfo = DateTimeFormatInfo.InvariantInfo; //��˹��ٻẺ�Ѵ�ѹ�����Ẻ�ҡ�

            //DateTimeFormatInfo myDTFI = new CultureInfo("en-US", false).DateTimeFormat;
            m_strDateTime = dtmInput.ToString(strDateStyle, dtfInfo);

            ////m_strDateTime = string.Format(strDateTime.ToString("yyyyMMdd")); Ẻ��������
        ...
        public static void DownLoadPicture(string fileName, PictureBox sender)
        {
            ...
            {
                PopMsg(EnuMsgType.MsgTypeError, "��辺����ٻ�Ҿ");
            }
        }
        ...
        public DataTable GetDataTableFromDGV(DataGridView dgv ,string sheetname)
        {
            ...
            foreach (DataGridViewColumn column in dgv.Columns)
            {
               if (column.Visible)
               {
                   ...
                   //if (column.Name.ToLower().Contains("bath") || column.Name.ToLower().Contains("fee") || column.Name.ToLower().Contains("price") || column.Name.ToLower().Contains("�Ҥ�") || column.Name.ToLower().Contains("cash") || column.Name.ToLower().Contains("credit") || column.Name.ToLower().Contains("net") || column.Name.ToLower().Contains("total") || column.Name.ToLower().Contains("amount") || column.Name.ToLower().Contains("��Ť��"))
                   if (column.Name.ToLower().Contains("����") || column.Name.ToLower().Contains("Ŵ") || column.Name.ToLower().Contains("pay") || column.Name.ToLower().Contains("bath") || column.Name.ToLower().Contains("fee") || column.Name.ToLower().Contains("price")
                              || column.Name.ToLower().Contains("�Ҥ�") || column.Name.ToLower().Contains("cash") || column.Name.ToLower().Contains("�Ѻ") || column.Name.ToLower().Contains("credit") || column.Name.ToLower().Contains("net") || column.Name.ToLower().Contains("total")
                              || column.Name.ToLower().Contains("���") || column.Name.ToLower().Contains("amount") || column.Name.ToLower().Contains("��Ť��") || column.Name.ToLower().Contains("�Թ") || column.Name.ToLower().Contains("�ӴѺ"))
                   {
                       dt.Columns.Add(column.HeaderText, typeof(double));
                   }
                   //else if (column.Name.ToLower().Contains("date") || column.Name.ToLower().Contains("�ѹ"))
...
//                    {
                        if (dgv.Columns[c.ColumnName].Name.ToLower().Contains("bath") | dgv.Columns[c.ColumnName].Name.ToLower().Contains("fee") | dgv.Columns[c.ColumnName].Name.ToLower().Contains("price") | dgv.Columns[c.ColumnName].Name.ToLower().Contains("�Ҥ�") | dgv.Columns[c.ColumnName].Name.ToLower().Contains("cash") 
                            ...
                            | dgv.Columns[c.ColumnName].Name.ToLower().Contains("amount") | dgv.Columns[c.ColumnName].Name.ToLower().Contains("��Ť��")|
                            dgv.Columns[c.ColumnName].Name.ToLower().Contains("����") || dgv.Columns[c.ColumnName].Name.ToLower().Contains("Ŵ") || dgv.Columns[c.ColumnName].Name.ToLower().Contains("pay") || dgv.Columns[c.ColumnName].Name.ToLower().Contains("bath") || dgv.Columns[c.ColumnName].Name.ToLower().Contains("fee") || dgv.Columns[c.ColumnName].Name.ToLower().Contains("price")
                                || dgv.Columns[c.ColumnName].Name.ToLower().Contains("�Ҥ�") || dgv.Columns[c.ColumnName].Name.ToLower().Contains("cash") || dgv.Columns[c.ColumnName].Name.ToLower().Contains("�Ѻ") || dgv.Columns[c.ColumnName].Name.ToLower().Contains("credit") || dgv.Columns[c.ColumnName].Name.ToLower().Contains("net") || dgv.Columns[c.ColumnName].Name.ToLower().Contains("total")
                                || dgv.Columns[c.ColumnName].Name.ToLower().Contains("���") || dgv.Columns[c.ColumnName].Name.ToLower().Contains("amount") || dgv.Columns[c.ColumnName].Name.ToLower().Contains("��Ť��") || dgv.Columns[c.ColumnName].Name.ToLower().Contains("�Թ") || dgv.Columns[c.ColumnName].Name.ToLower().Contains("�ӴѺ"))
                            try 
	                        {
                        ...
                        //else if (dgv.Columns[c.ColumnName].Name.ToLower().Contains("date") || dgv.Columns[c.ColumnName].Name.ToLower().Contains("�ѹ"))
                   ...
                   // dgvReturn = dgvData;
                    ...
                    foreach (DataGridViewColumn column in dgvData.Columns)
                    {
                        if (column.Visible)
                        {
                            if (column.Name.ToLower().Contains("����") || column.Name.ToLower().Contains("Ŵ") || column.Name.ToLower().Contains("pay") || column.Name.ToLower().Contains("bath") || column.Name.ToLower().Contains("fee") || column.Name.ToLower().Contains("price") 
                                || column.Name.ToLower().Contains("�Ҥ�") || column.Name.ToLower().Contains("cash")|| column.Name.ToLower().Contains("�Ѻ") || column.Name.ToLower().Contains("credit") || column.Name.ToLower().Contains("net") || column.Name.ToLower().Contains("total")
                                || column.Name.ToLower().Contains("�ѡ") || column.Name.ToLower().Contains("���") || column.Name.ToLower().Contains("amount") || column.Name.ToLower().Contains("��Ť��") || column.Name.ToLower().Contains("�Թ") || column.Name.ToLower().Contains("�ʹ")
                                || column.Name.ToLower().Contains("����") || column.Name.ToLower().Contains("�ӹǹ"))
                            {
