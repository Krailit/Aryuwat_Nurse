...
namespace AryuwatSystem.DerClass
{
    public static class Statics
    {
        ...
        /// <summary>
        /// ��˹������ҹ������ҧ� ��� Enable �� true, false
        /// </summary>
        /// <param name="btnNew">���� New</param>
        /// <param name="btnEdit">���� Edit</param>
        /// <param name="btnDelete">���� Delete</param>
        /// <param name="btnPrint">���� Print</param>
        /// <param name="btnRefresh">���� Refresh</param>
        ///  
