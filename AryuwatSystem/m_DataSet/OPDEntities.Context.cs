...
namespace AryuwatSystem.m_DataSet
{
    ...
    public partial class EntitiesOPD_System : DbContext
    {
        public EntitiesOPD_System()
            : base("name=EntitiesOPD_System")
        {
        }
        ...
        public virtual IQueryable<SplitString_Result> SplitString(string str, string separator)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<SplitString_Result>("[EntitiesOPD_System].[SplitString](@str, @separator)", strParameter, separatorParameter);
        }
