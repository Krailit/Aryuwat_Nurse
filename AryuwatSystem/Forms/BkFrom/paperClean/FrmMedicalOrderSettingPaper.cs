...
using DermasterSystem.DerClass;
using Entity;
                    ...
                    foreach (DataGridViewRow item in dv.Rows)//ถ้าเลือกรายการแบบทั่วไป ใช้อันนี้
                    {
                        if ((bool)item.Cells[0].Value == true)
                        {
                            ...
                            object[] myItems = {
                                          ...
                                          false,//Extras_sale
                                          false,//VIP
                                          PRO_CalType=="A" || PRO_CalType=="B"?true:false,//Pro  ตอนนี้คือ Addist
                                           tabTyp,
    ...
    private void FilterList(DataGridView dgv,DataTable dt,string txtFilter,string tab)
    {
        ...
        private void CallFormRef(Statics.CallMode cMode)
        {
            ...
            string ms_code = "";
               ...
               Statics.frmMedicalOrderSettingPaper.BackColor = Color.FromArgb(170, 232, 229);
