...
namespace AryuwatSystem.Forms
{
    public partial class PopBookingAdd : Form
    {
        public PopBookingAdd()
        {
            ...
            BindCboTreatment();
            cboTreadment.MouseWheel += new MouseEventHandler(cboTreadment_MouseWheel);
            
     }

        void cboTreadment_MouseWheel(object sender, MouseEventArgs e)
        {
    ...
    private void buttonAdd_Click(object sender, EventArgs e)
    {
        ...
        this.DrID = txtDr.Text.Length<5?"":DrID;
        this.DrName = txtDr.Text;
    ...
    {
            cboTreadment.DroppedDown = false;
