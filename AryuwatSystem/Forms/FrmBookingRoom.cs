    ...
    public partial class FrmBookingRoom : DockContent, IForm
    {
                        ...
                        for (num = 0; num < strArray.Length; num++)
                        {
                            ...
                            if (rowArray.Length > 0)
                            {
                                for (int i = 0; i < rowArray.Length; i++)
                                {
                                    ...
                                    if (Convert.ToDateTime(rowArray[i]["DateShowStart"] + "").TimeOfDay == e.Item.StartDate.TimeOfDay )// �������������¹�� ������ͧ��
                                    {
                                        ...
                                        text = string.Format("{0} �١�ͧ�������,��ͧ {1},���� {2}{3}{4}{5}{6}", args[0], args[1], args[2], args[3], args[4], Environment.NewLine, "��س� ���͡�����ա����");
                                    }
                                }
                            }
                        }
        ...
        private DataTable MergTable(DataSet ds)
        {
            ...
            try
            {
                ...
                {
                    foreach (DataRow item in dtData.Rows)//������ book
                    {
                        string EndDate = item["DateShowEnd"].ToString().Trim().ToLower();
                        foreach (DataRow drOK in dtok.Rows)//���ҧ����
                        {
