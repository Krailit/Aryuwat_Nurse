...
{
    public partial class FrmEditREQ : DockContent
    {
        bool bind = true;
        ...
        private void FrmEditREQ_Load(object sender, EventArgs e)
        {
        ...
        private void FrmEditREQ_FormClosing(object sender, FormClosingEventArgs e)
        {
            Statics.frmEditREQ = null;
        }
