...
namespace AryuwatSystem.Forms
{
    public partial class FrmFreeMarketing : DockContent
    {
        ...
        public FrmFreeMarketing()
        {
            InitializeComponent();
            //SetColumns();
           
            FormType = DerUtility.AccessType.Insert;
            this.Closing += new CancelEventHandler(FrmFreeMarketing_Closing);
        }


        void FrmFreeMarketing_Closing(object sender, CancelEventArgs e)
        {
            //Statics.FrmFreeMarketing = null;
        }
        #region Event
        ...
        public void BindApproveComplication(int _pIntseq)
        {
            try
            {
                DataTable dtmb = Entity.Userinfo.MoConfig.Select("[key]='ApproveMKT'").CopyToDataTable();
        ...
        private void SelectApplove()
        {
            try
            {
                ...
                Applove1Txt = comboBoxApplove.Text + "";
                Remark = txtNote.Text;
                //this.Close();
                this.Visible = false;
                //MessageBox.Show(Statics.FrmFreeMarketing.GiftCode);
        ...
        private void FrmFreeMarketing_Load(object sender, EventArgs e)
        {
