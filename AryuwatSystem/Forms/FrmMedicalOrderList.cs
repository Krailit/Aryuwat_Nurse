...
//}
        private void SetColumns()
        {
            try
            {
                ...
                dgvData.Columns.Add("soMoveOut", "โอนไปที่");
                dgvData.Columns.Add("PriceCreditMoveOut", "จำนวนเงินโอนออก");

                dgvData.Columns.Add("MedStatus_NameUse", "ใช้คอร์ส/Use");
                dgvData.Columns.Add("SORef", "ใบยาอ้างอิง");
                dgvData.Columns.Add("PriceCreditRef", "ยอดโอนมา");
                dgvData.Columns.Add("Consult", "Consult");
                dgvData.Columns.Add("PRO_Type", "PRO_Type");
            ...
            try
            {
                ...
                foreach (DataRowView item in dtList.DefaultView)
                {
                    ...
                    object[] myItems = {
                                          ...
                                          item["CourseCardID"] + "",
                                          item["soMoveOut"]+"",
                                          item["PriceCreditMoveOut"]+""==""?"":Convert.ToDecimal(item["PriceCreditMoveOut"]+"").ToString("###,###,###.##"),
               ...
               // FilterSOMO(checkBoxSO.Checked, checkBoxMO.Checked);
                ...
                foreach (DataGridViewRow dataRow in dgvData.Rows)
                {
                    ...
                    else if (MedStatus_Code == "99"  )//99CourseClose  10 expire  4 Finish
                    {
                    ...
                    // if (MedStatus_CodeUsed == "finish")//99CourseClose  10 expire  4 Finish
                    //{
                    //    dataRow.DefaultCellStyle.ForeColor = Color.DarkSlateGray;
                    //    dataRow.DefaultCellStyle.Font = new Font(dgvData.DefaultCellStyle.Font, FontStyle.Strikeout);
                    //}
                   // if (MedStatus_CodeUsed == "finish") dataRow.DefaultCellStyle.Font = new Font(dgvData.DefaultCellStyle.Font, FontStyle.Strikeout);
                }
                //MedStatus_Code	MedStatus_Name
                //        1	Deposit
                //        2	Paid
                //        3	Referent
                //        4	Finish
