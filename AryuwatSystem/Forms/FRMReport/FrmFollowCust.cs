...
{
    public partial class FrmFollowCust : DockContent
    {
        ...
        public void BindDataCommission(int _pIntseq)
        {
            try
            {
                ...
                {
                    info.QueryType = "RptAllCoverCheckFollow";
                }
        ...
        private void FrmFollowCust_Load(object sender, EventArgs e)
        {
        ...
        private void FrmFollowCust_FormClosing(object sender, FormClosingEventArgs e)
        {
            Statics.frmFollowCust = null;
          }
