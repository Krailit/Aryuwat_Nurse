...
{
    public partial class FrmReportHR_Fee_Month_Year : DockContent
    {
        bool bind = true;
        ...
        DataSet dsData;
        public FrmReportHR_Fee_Month_Year()
        {
            InitializeComponent();
        }
        ...
        private void FrmReportHR_Fee_Month_Year_Load(object sender, EventArgs e)
        {
        ...
        private void FrmReportHR_Fee_Month_Year_FormClosing(object sender, FormClosingEventArgs e)
        {
            Statics.frmReportHR_Fee_Month_Year = null;
        }
