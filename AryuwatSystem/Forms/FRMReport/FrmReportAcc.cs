...
{
    public partial class FrmReportAcc : DockContent
    {
        bool bind = true;
        ...
        private void FrmReportAcc_Load(object sender, EventArgs e)
        {
                ...
                if (saveFileDialog1.ShowDialog() == DialogResult.OK)
                {
                   ...
                   // dt = city.GetAllCity();//your datatable
                    using (ClosedXML.Excel.XLWorkbook wb = new ClosedXML.Excel.XLWorkbook())
                    {
                        ...
                        //ExportDataWithClosedXml_Method(dtAllTotal.DefaultView.ToTable(), "Result", titlereport);
        ...
        private void FrmReportAcc_FormClosing(object sender, FormClosingEventArgs e)
        {
            Statics.frmReportAcc = null;
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else if (QueryType == "RptAccClearPending")
                {
                    obj.PrintType = string.Format(" วันที่ {0} - {1}", txtStartdate.Text, txtEnddate.Text);
                }
                else
