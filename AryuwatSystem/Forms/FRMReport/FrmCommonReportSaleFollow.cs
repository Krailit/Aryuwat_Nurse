...
{
    public partial class FrmCommonReportSaleFollow : DockContent
    {
        bool bind = true;
        ...
        DataSet dsData;
        public FrmCommonReportSaleFollow()
        {
            InitializeComponent();
        }
        ...
        public void BindReportFollow(int pIntseq)
        {
            try
            {
                ...
                MedStatus_CodeClosed = checkBoxClosed.Checked ? "2" : null;
        ...
        private void FrmCommonReportSaleFollow_Load(object sender, EventArgs e)
        {
        ...
        private void FrmCommonReportSaleFollow_FormClosing(object sender, FormClosingEventArgs e)
        {
            Statics.frmCommonReportSaleFollow = null;
        }
