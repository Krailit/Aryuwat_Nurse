...
{
    public partial class FrmCommonReportWE_Month : DockContent
    {
        bool bind = true;
        ...
        public FrmCommonReportWE_Month()
        {
            InitializeComponent();
        ...
        public void BindReportAE_report(int pIntseq)
        {
            try
            {
                ...
                if (radioGroupAE_countMORef.Checked)
                    info.QueryType = "ReportWE_Month_MORef";
                else if (radioGroupAE_countMORef_S.Checked)
                    info.QueryType = "ReportWE_Month_MORef_S";
                else if (radioGroupAEJobcost.Checked)
                    info.QueryType = "ReportWE_Month_SOnotS";
                else if (radioGroupAE_countMORef_Year.Checked)
                    info.QueryType = "ReportWE_Year_MORef";
                else if (radioGroupORJobCostYear.Checked)
                    info.QueryType = "ReportWE_Year_SOnotS";
                else if (radioGroupAE_CNCase.Checked)
                    info.QueryType = "ReportWE_Month_CN";
                else if (radioGroupORJobCostCaseYear.Checked)
                    info.QueryType = "ReportWE_Year_CN";


                dsData = new Business.Report().SelectReportWE(info);
                decimal SalePrice = 0;
                decimal MS_Price = 0;
                decimal Amount = 0;
                ...
                dataGridViewCellStylex.Font = new System.Drawing.Font("Tahoma", 9F);
        ...
        private void FrmCommonReportWE_Month_Load(object sender, EventArgs e)
        {
        ...
        private void FrmCommonReportWE_Month_FormClosing(object sender, FormClosingEventArgs e)
        {
            Statics.frmCommonReportWE_Month = null;
        }
