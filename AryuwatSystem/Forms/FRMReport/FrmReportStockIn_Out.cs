...
{
    public partial class FrmReportStockIn_Out : DockContent
    {
        bool bind = true;
        ...
        public void BindMedicalSupplies(int _pIntseq)
        {
            try
            {
                ...
                //}
                if(radioButtonBalance.Checked)
                info.QueryType = "STOCKbalance";
                else if (radioButtonSellDay.Checked)
                    info.QueryType = "STOCKSellDay";
                else if (radioButtonSellMonth.Checked)
                    info.QueryType = "STOCKSellMonth";
                else if (radioButtonRecieptDay.Checked)
                    info.QueryType = "STOCKReceiptMonth";
                else if (radioButtonRecieptMonth.Checked)
                    info.QueryType = "STOCKReceiptMonth";
                ...
                dtAllTotal = new Business.MedicalSupplies().SelectMedicalSuppliesPaging(info).Tables[0];
        ...
        private void FrmReportStockIn_Out_Load(object sender, EventArgs e)
        {
        ...
        private void FrmReportStockIn_Out_FormClosing(object sender, FormClosingEventArgs e)
        {
            Statics.frmReportStockIn_Out = null;
        }
        ...
        private void radioButtonBalance_Click(object sender, EventArgs e)
        {
            ...
            titlereport = radioButtonBalance.Text;
        }

        private void radioButtonRecieptDay_Click(object sender, EventArgs e)
        {
            //labelStart.Enabled = true;
            //labelEnd.Enabled = true;
            //txtStartdate.Enabled = true;
            //txtEnddate.Enabled = true;
            titlereport = radioButtonSellDay.Text;
            txtEnddate.Text = DateTime.Now.ToString("dd/MM/yyyy");
            txtStartdate.Text = DateTime.Now.ToString("dd/MM/yyyy");
        }

        private void radioButtonRecieptMonth_Click(object sender, EventArgs e)
        {
            labelStart.Enabled = true;
            labelEnd.Enabled = true;
            txtStartdate.Enabled = true;
            txtEnddate.Enabled = true;
            titlereport = radioButtonSellMonth.Text;

            txtStartdate.Text = DateTimeUtil.FirstDayOfMonth(Convert.ToInt16(DateTime.Now.Year), DateTime.Now.Month).ToString("dd/MM/yyyy");
            txtEnddate.Text = DateTimeUtil.LastDayOfMonth(Convert.ToInt16(DateTime.Now.Year), DateTime.Now.Month).ToString("dd/MM/yyyy");
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (radioButtonBalance.Checked)
                {
                    obj.PrintType = string.Format(" ณ วันที่ {0}",DateTime.Now.ToString("dd/MM/yyyy"));
                    obj.FormName = "RptStockBalance";
                }
                if (radioButtonRecieptDay.Checked)
                {
                    obj.PrintType = string.Format(" วันที่ {0} - {1}", AryuwatSystem.DerClass.DerUtility.ToFormatDateyyyyMMdd(txtStartdate.Text), AryuwatSystem.DerClass.DerUtility.ToFormatDateyyyyMMdd(txtEnddate.Text));
                    obj.FormName = "RptStockReceipt";
                }
                if (radioButtonRecieptMonth.Checked)
                {
                    obj.PrintType = string.Format(" เดือน{0}", AryuwatSystem.DerClass.DerUtility.IsMonthNameThai(Convert.ToDateTime(AryuwatSystem.DerClass.DerUtility.ToFormatDateyyyyMMdd(txtStartdate.Text)).Month));
                    obj.FormName = "RptStockReceipt";
                }
                if (radioButtonSellDay.Checked)
                {
                    obj.PrintType = string.Format(" วันที่ {0} - {1}", AryuwatSystem.DerClass.DerUtility.ToFormatDateyyyyMMdd(txtStartdate.Text), AryuwatSystem.DerClass.DerUtility.ToFormatDateyyyyMMdd(txtEnddate.Text));
                    obj.FormName = "RptStockSell";
                }
                if (radioButtonSellMonth.Checked)
                {
                    obj.PrintType = string.Format(" เดือน{0}", AryuwatSystem.DerClass.DerUtility.IsMonthNameThai(Convert.ToDateTime(AryuwatSystem.DerClass.DerUtility.ToFormatDateyyyyMMdd(txtStartdate.Text)).Month));
                    obj.FormName = "RptStockSell";
                }
        ...
        private void radioButtonRecieptMonth_Click_1(object sender, EventArgs e)
        {
            labelStart.Enabled = true;
            labelEnd.Enabled = true;
            txtStartdate.Enabled = true;
