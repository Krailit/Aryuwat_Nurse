...
namespace AryuwatSystem.Forms.PrintGridView
{
    class PrintDGV
    {
        private static StringFormat StrFormatLeft;  // Holds content of a TextBox Cell to write by DrawString
        private static StringFormat StrFormatRight;  // Holds content of a TextBox Cell to write by DrawString
        private static StringFormat StrFormatCenter;  // Holds content of a TextBox Cell to write by DrawString
        ...
        private static bool OrientationLandScape = true; // True = LandScape  
        private static int HeaderHeight = 0;

        public static void Print_DataGridViewJobCost(DataGridView dgv1)
        {
            ...
            try
            {
                ...
                dlg.txtTitle.Text = dgv1.Tag.ToString();
                ...
                PrintDialog myPrinterDialog = new PrintDialog();

                myPrinterDialog.PrinterSettings.DefaultPageSettings.Landscape = true;
                myPrinterDialog.PrinterSettings.DefaultPageSettings.Margins.Top = 100;
                myPrinterDialog.PrinterSettings.DefaultPageSettings.Margins.Left = 40;
                myPrinterDialog.PrinterSettings.DefaultPageSettings.Margins.Right = 50;
                myPrinterDialog.PrinterSettings.DefaultPageSettings.Margins.Bottom = 10;

                myPrinterDialog.ShowDialog();
                printDoc.PrinterSettings = myPrinterDialog.PrinterSettings;
        ...
        public static void Print_DataGridViewA4Portrait(DataGridView dgv1)
        {
            PrintPreviewDialog ppvw;
            try 
	        {	
                ...
                myPrinterDialog.PrinterSettings.DefaultPageSettings.Landscape = false;
                myPrinterDialog.PrinterSettings.DefaultPageSettings.Margins.Top = 50;
                myPrinterDialog.PrinterSettings.DefaultPageSettings.Margins.Left = 10;
                myPrinterDialog.PrinterSettings.DefaultPageSettings.Margins.Right = 50;
                myPrinterDialog.PrinterSettings.DefaultPageSettings.Margins.Bottom = 20;
        ...
        public static void Print_DataGridView(DataGridView dgv1)
        {
            ...
            try
            {
                ...
                myPrinterDialog.PrinterSettings.DefaultPageSettings.Landscape = OrientationLandScape;
                myPrinterDialog.PrinterSettings.DefaultPageSettings.Margins.Top = 50;
                myPrinterDialog.PrinterSettings.DefaultPageSettings.Margins.Left = 10;
                myPrinterDialog.PrinterSettings.DefaultPageSettings.Margins.Right = 50;
                myPrinterDialog.PrinterSettings.DefaultPageSettings.Margins.Bottom = 20;
                ...
                ppvw = new PrintPreviewDialog();
                printDoc.DefaultPageSettings.Landscape = OrientationLandScape;
                printDoc.DefaultPageSettings.Margins.Top = 50;
                printDoc.DefaultPageSettings.Margins.Left = 10;
                printDoc.DefaultPageSettings.Margins.Right = 50;
                printDoc.DefaultPageSettings.Margins.Bottom = 20;
        ...
        public static void Print_DataGridViewA3(DataGridView dgv1)
        {
            PrintPreviewDialog ppvw;
            try
            {
                ...
                myPrinterDialog.PrinterSettings.DefaultPageSettings.Margins.Left = 10;
                myPrinterDialog.PrinterSettings.DefaultPageSettings.Margins.Right = 50;
                myPrinterDialog.PrinterSettings.DefaultPageSettings.Margins.Bottom = 25;
                

                foreach (System.Drawing.Printing.PaperSize ps in printDoc.PrinterSettings.PaperSizes)
                {
                    if (ps.PaperName.Contains("A3"))
                        myPrinterDialog.PrinterSettings.DefaultPageSettings.PaperSize = ps;
                }
                myPrinterDialog.ShowDialog();
        ...
        public static void Print_DataGridViewBooking(DataGridView dgv1)
        {
            PrintPreviewDialog ppvw;
            try
            {
                ...
                //declares printdialog for retrieving desired printer and other settings
                PrintDialog myPrinterDialog = new PrintDialog();
                myPrinterDialog.PrinterSettings.DefaultPageSettings.Landscape = true;
                foreach (System.Drawing.Printing.PaperSize ps in printDoc.PrinterSettings.PaperSizes)
                {
                ...
                myPrinterDialog.PrinterSettings.DefaultPageSettings.Landscape = OrientationLandScape;
                myPrinterDialog.PrinterSettings.DefaultPageSettings.Margins.Top = 40;
                myPrinterDialog.PrinterSettings.DefaultPageSettings.Margins.Left = 10;
                myPrinterDialog.PrinterSettings.DefaultPageSettings.Margins.Right = 40;
                myPrinterDialog.PrinterSettings.DefaultPageSettings.Margins.Bottom = 10;
                //myPrinterDialog.AllowSomePages = true; //May not be needed
                //myPrinterDialog.PrinterSettings.PrintRange = PrintRange.SomePages; //Needed
                ...
                //printDoc.PrinterSettings.DefaultPageSettings.PrinterSettings.
                ...
                // Showing the Print Preview Page
                printDoc.BeginPrint += new System.Drawing.Printing.PrintEventHandler(PrintDoc_BeginPrint);
                printDoc.PrintPage += new System.Drawing.Printing.PrintPageEventHandler(PrintDoc_PrintPageBook);
                if (ppvw.ShowDialog() != DialogResult.OK)
                {
                    printDoc.BeginPrint -= new System.Drawing.Printing.PrintEventHandler(PrintDoc_BeginPrint);
                    printDoc.PrintPage -= new System.Drawing.Printing.PrintPageEventHandler(PrintDoc_PrintPageBook);
                ...
                {
                    printDoc.Print();//this will trigger the Print Event handeler PrintPage
                }
                printDoc.BeginPrint -= new System.Drawing.Printing.PrintEventHandler(PrintDoc_BeginPrint);
                printDoc.PrintPage -= new System.Drawing.Printing.PrintPageEventHandler(PrintDoc_PrintPageBook);
            }
                    ...
                    System.Drawing.Printing.PrintEventArgs e) 
        {
            try
	        {
                ...
                StrFormatLeft.Trimming = StringTrimming.EllipsisCharacter;
                // Formatting the Content of Text Cell to print
                StrFormatRight = new StringFormat();
                StrFormatRight.Alignment = StringAlignment.Far;
                StrFormatRight.LineAlignment = StringAlignment.Center;
                ...
                StrFormatCenter.Trimming = StringTrimming.EllipsisCharacter;
        ...
        private static bool ISNumber(string values,string header)
        {
            bool ok=false;
            if (header == "�ӴѺ")
                ok = false;
            ...
            {
                double num = 0;
               ok= Double.TryParse(values, out num);
            }
            ...
            try
            {
                ...
                if (PageNo == 1)
                {
                    foreach (DataGridViewColumn GridCol in dgv.Columns)
                    {
                        ...
                        if (GridCol.Index == 0) tmpWidth += 10;
                ...
                while (RowPos <= dgv.Rows.Count - 1)
                {
                    ...
                    else
                    {
                        ...
                        {
                            // Draw Header
                            e.Graphics.DrawString(PrintTitle, new Font(dgv.Font, FontStyle.Bold), Brushes.Black, e.MarginBounds.Left, e.MarginBounds.Top - e.Graphics.MeasureString(PrintTitle, new Font(dgv.Font,
                            ...
                            foreach (DataGridViewColumn GridCol in dgv.Columns)
                            {
                                ...
                                e.Graphics.DrawString(GridCol.HeaderText, GridCol.InheritedStyle.Font,
                                    ...
                                    (int)ColumnWidths[i], HeaderHeight), StrFormatCenter);
                                i++;
                            }
                            NewPage = false;
                            tmpTop += HeaderHeight;
                        ...
                        foreach (DataGridViewCell Cel in GridRow.Cells)
                        {
                                ...
                                ((Type)ColumnTypes[i]).Name == "DataGridViewLinkColumn")
                            {
                                ...
                                e.Graphics.DrawString(Cel.Value + "" == "" ? "" : Cel.Value.ToString(), Cel.InheritedStyle.Font,
                                                                     new SolidBrush(Cel.InheritedStyle.ForeColor),
                                                                     new RectangleF((int)ColumnLefts[i], (float)tmpTop,
                                                                     (int)ColumnWidths[i], (float)CellHeight), ISNumber(Cel.Value + "", Cel.OwningColumn.HeaderText) ? StrFormatRight : StrFormatLeft);
                            }
        ...
        private static void PrintDoc_PrintPageBook(object sender,System.Drawing.Printing.PrintPageEventArgs e) 
        {
            int tmpWidth, i;
            int tmpTop = e.MarginBounds.Top;
            int tmpLeft = e.MarginBounds.Left;
                    ...
                    else
                    {
                        ...
                        foreach (DataGridViewCell Cel in GridRow.Cells)
                        {
                            ...
                            e.Graphics.DrawRectangle(Pens.Black, new Rectangle((int)ColumnLefts[i], tmpTop, (int)ColumnWidths[i], CellHeight));
                                if (IsTheSameCellValue(Cel.ColumnIndex, Cel.RowIndex) )
                                {
                                    //e.Graphics.DrawRectangle(Pens.White, new Rectangle((int)ColumnLefts[i],tmpTop, (int)ColumnWidths[i], CellHeight));
                                    //Point p1=new Point((int)ColumnLefts[i],tmpTop);
                                    //Point p2=new Point(Cel.);
                                    //e.Graphics.DrawLine(Pens.White,,(int)ColumnLefts[i], tmpTop);
                                    e.Graphics.DrawRectangle(Pens.White, new Rectangle((int)ColumnLefts[i], tmpTop, (int)ColumnWidths[i], 1));
     ...
     static bool IsTheSameCellValue(int column, int row)
        {
