...
namespace AryuwatSystem.Forms
{
    public partial class FrmPreviewRpt2Page : Form
    {
            ...
            try
            {
                switch (FormName)
                {
                    ...
                    case "RptSOFTaxVat"://ใบกำกับภาษี vat
                        ...
                        break;
                    case "RptSOFTaxVatClinic"://ใบกำกับภาษี vat
                        //if (HasDiscount) DisplayRptSOFBill2VatDiscount();
                        //else DisplayRptSOFBill2VatNoDiscount();
                        DisplayRptSOFBill2VatNoDiscountClinic();
        ...
        private void DisplayRptSOFINVNonVatDiscountClinic()
        {
            //RptSOFBill2NoVat rpt = new RptSOFBill2NoVat();
            RptSOFInvNoVatDiscountClinic rpt = new RptSOFInvNoVatDiscountClinic();
        ...
        private void DisplayRptSOFBill2VatNoDiscountClinic()
        {
            RptSOFTaxVatClinic rpt = new RptSOFTaxVatClinic();
