...
namespace DermasterSystem.Forms
{
    public partial class FrmPersonnelList : DockContent, IForm
    {
        ...
        private void NewCustomer()
        {
            ...
            Statics.frmPersonnelSetting.BackColor = Color.FromArgb(170, 232, 229);
        ...
        private void CallForm(CallMode cMode)
        {
            try
            {
                ...
                {
                    Statics.frmPersonnelSetting.FormType = Utility.AccessType.DisplayOnly;
                }
                else if (cMode == CallMode.Update)
                {
                    Statics.frmPersonnelSetting.FormType = Utility.AccessType.Update;
                }
