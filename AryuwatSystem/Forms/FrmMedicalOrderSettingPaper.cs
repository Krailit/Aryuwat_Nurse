...
{
    public partial class FrmMedicalOrderSettingPaper : DockContent, IForm
    {

        public FrmMedicalOrderSettingPaper()
        {
            InitializeComponent();
        ...
        public FrmMedicalOrderSettingPaper(ref Entity.Customer info)
        {
            InitializeComponent();
            comboBoxCommission1.MouseWheel += new MouseEventHandler(comboBoxCommission1_MouseWheel);
            comboBoxCommission2.MouseWheel += new MouseEventHandler(comboBoxCommission2_MouseWheel);
        ...
        DataTable dtRefVN = new DataTable();     
        ...
        public decimal ProPricePayx = 0;
              ...
              private void FrmMedicalOrderSettingPaper_Load(object sender, EventArgs e)
              {
                  try
                  {
                      ...
                      else //New
                      {
                          ...
                          this.idMax = UtilityBackEnd.GenMaxSeqnoValues("VN",cboBranch.SelectedValue+"");
                          txtRefVN.Text = idMax;
                          //this.txtSONo.Text =  this.idMax.Replace("VNM", moso);
                          //this.idMax = this.idMax.Replace(moso, "").Replace("VNM", "");
        ...
        public void BindCommission()
        {
            try
            {
                ...
                comboBoxCommission1.SelectedValue = Userinfo.EN;
        ...
        private void BindData()
        {
            ...
            DataSet ds = new Business.MedicalOrder().SelectMedicalOrderRefVNById(RefVN);
             dtRefVN = ds.Tables[0];
            //DataTable dtRefVNTrans = ds.Tables[1];
            ...
            CN = dtRefVN.Rows[0]["CN"] + "";
           // radioButtonMO.Checked = dtMed.Rows[0]["MOType"] + ""=="Y";
            //txtRefVN.Visible = dtMed.Rows[0]["MOType"] + "" != "Y";
            //labelSOrefAcc.Visible = dtRefVN.Rows[0]["MOType"] + "" != "Y";
            //radioButtonMO.Enabled = !radioButtonMO.Checked;
            //radioButtonSO.Enabled = !radioButtonMO.Checked;
            //MOType = dtRefVN.Rows[0]["MOType"] + "";
            //this.RefVN = dtRefVN.Rows[0]["SOClose"] + "";
            //this.PriceRef = (this.RefVN != "") ? (dtRefVN.Rows[0]["PriceTotalRef"] + "") : "";
            //ProCreditRemark = dtMed.Rows[0]["Remark"] + "";
            txtRemark.Text = dtRefVN.Rows[0]["Remark"] + "";
            //checkBoxOld.Checked = dtMed.Rows[0]["OldKey"] + ""=="Y";
            //this.showRef();

            //customerType = dtRefVN.Rows[0]["CustomerType"] + "";
            txtCustomerName.Text = dtRefVN.Rows[0]["FullNameThai"] + "" == "" ? dtRefVN.Rows[0]["FullNameEng"] + "" : dtRefVN.Rows[0]["FullNameThai"] + "";
            labelCN.Text = dtRefVN.Rows[0]["CN"] + "";
            //txtAgenMemID.Text = dtRefVN.Rows[0]["AgenMemID"] + "";
            //txtAgenMemName.Text = dtRefVN.Rows[0]["agencyFullNameThai"] + "";
            //txtAgenMemIDOPD.Text = dtRefVN.Rows[0]["AgenMemIDOPD"] + "";
            //txtAgenMemNameOPD.Text = dtRefVN.Rows[0]["agencyOPDFullNameThai"] + "";
            ...
            dateTimePickerCreate.Value = dtRefVN.Rows[0]["DateRefVN"] + "" == "" ? DateTime.Now : Convert.ToDateTime(dtRefVN.Rows[0]["DateRefVN"] + "");
            //txtSONo.Text = dtMed.Rows[0]["SONo"] + "";
            //txtSoRef.Text = dtMed.Rows[0]["SORef"] + "";
            txtRefVN.Text = dtRefVN.Rows[0]["RefVN"] + ""; 

            //txtRefVN.Text = dtMed.Rows[0]["SORefAccount"] + "";
           // txtBalanceRef.Text = dtMed.Rows[0]["PriceCreditRef"] + "" == "" ? "" : Convert.ToDouble(dtMed.Rows[0]["PriceCreditRef"] + "").ToString("###,###,###.##"); ;  
            comboBoxCommission1.SelectedValue = dtRefVN.Rows[0]["EN_COMS1"] + "";
            comboBoxCommission2.SelectedValue = dtRefVN.Rows[0]["EN_COMS2"] + "";
            comboBoxByDr.SelectedValue = dtRefVN.Rows[0]["DR_COM"] + "";


            labelKey1.Text = dtRefVN.Rows[0]["SaveBy"] + "";
...
//    btnSave.Enabled = false; 
            ...
            foreach (DataRow dr in dtRefVN.Rows)
                {
                        ...
                        if ((dr["MS_Code"] + "").Contains("PRO_CREDIT"))//ถ้าเป็น โปรวงเงิน
                        {
                        ...
                        else
                        {
                                    ...
                                    object[] myItems = {
                                               ...
                                               double.Parse(dr["Discount"] + "").ToString("###,###.##"),//Discount,
                                                dr["PriceAfterDis"] + ""==""?"0":Convert.ToDouble(dr["PriceAfterDis"] + "").ToString("###,###,###.##"),
                                               dr["Tab"] + "",
                                               dr["Note"]+"",
                                               dr["ListOrder"]+"",
                                               false,//dr["SaleCom"] + "" == "Y" ? true : false,
                                               false,//dr["ByDr"] + "" == "Y" ? true : false,//
                                               false,//dr["Canceled"] + "" == "Y" ? true : false,
                                               "",//dr["Gift"] + "" ,
                                               "",//dr["FreeType"] + "" ,
                                               //  "",//dr["AmountPro"]+"",
                                               // "",//dr["PricePerPro"]+"",
        ...
        private void SetColumnDgvSelectList()
        {
            ...
            dataGridViewSelectList.Columns.Add("Discount", "Discount");//10
            dataGridViewSelectList.Columns["Discount"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
            dataGridViewSelectList.Columns["Discount"].DefaultCellStyle.ForeColor = Color.Blue;
            dataGridViewSelectList.Columns["Discount"].ReadOnly = true;
            dataGridViewSelectList.Columns["Discount"].Width = 90;
        ...
        private void BindCboBranch()
        {
            try
            {
                ...
                cboBranch.SelectedValue = Userinfo.BranchId ;
            }
            catch (Exception ex)
            {
                ...
                else
                {
                    ...
                    foreach (DataGridViewRow item in dv.Rows)//ถ้าเลือกรายการแบบทั่วไป ใช้อันนี้
                    {
                        if ((bool)item.Cells[0].Value == true)
                        {
                            ...
                            dblAmount = (item.Cells["Code"].Value + "").ToUpper().Contains(Entity.Userinfo.FIX_COOL) ? 2 : 1;//จำนวนที่ซื้อ   //ATBS0304 Cool Plus ใส่ 2 จุดอตโนมัติ
                            ...
                            object[] myItems = {
                                           ...
                                           item.Cells["MS_Number_C"].Value,//Num/Couse
                                            (item.Cells["Code"].Value + "").ToUpper().Contains(Entity.Userinfo.FIX_COOL)?"2":"1",//จำนวนที่ซื้อ   //ATBS0304 Cool Plus ใส่ 2 จุดอตโนมัติ
                                           "0",//Total
                                          MS_Price,//PricePer
    ...
    private void FilterList(DataGridView dgv,DataTable dt,string txtFilter,string tab)
    {
        try
        {
            ...
            else
            {
                if (tab.ToLower().IndexOf("pro") > -1)
                    dv.RowFilter = string.Format("[PRO_Code] LIKE '%{0}%' or [PRO_Name] LIKE '%{0}%'", txtFilter);
                else
                {
                    dv.RowFilter = string.Format("[MS_Code] LIKE '%{0}%' or [MS_Name] LIKE '%{0}%'", txtFilter);
                }
        ...
        private void txtWellness_Antiaging_KeyUp(object sender, KeyEventArgs e)
        {
            ...
            //}
               try
               {
                   //if (txtWellness_Antiaging.Text.Length == 0) return;
            ...
            try
            {
               // if (ISEndEdit) return;
                ...
                else
                {
                    ...
                    if (pritotal < Price50Per && Free == false )
                    {
                    ...
                    bool adddis = false;// (ch1.Value + "").ToLower() == "true";
                    ...
                    {
                        SPPrice = dataGridViewSelectList.Rows[RowIndex].Cells["SpecialPrice"].Value + "" == "" ? 0 : decimal.Parse(dataGridViewSelectList.Rows[RowIndex].Cells["SpecialPrice"].Value + "");
                        pritotal = (dblAmount * dbPricePerU) + SPPrice;
                    }
        ...
        //    Statics.frmMedicalOrderSettingPaper.FormType = DerUtility.AccessType.Insert;
        //    Statics.frmMedicalOrderSettingPaper.Text = Text + Statics.StrNewRow;
        //    //Statics.frmMedicalOrderSettingPaper.SORef = txtSONo.Text;

        //    Statics.frmMedicalOrderSettingPaper.ProCreditRemain = dt.Rows.Count <= 0 ? 0 : Convert.ToDecimal(dt.Rows[0]["Pending"] + "");
        //    Statics.frmMedicalOrderSettingPaper.RefCN = CN;
        //    Statics.frmMedicalOrderSettingPaper.CN = CN;
        //    Statics.frmMedicalOrderSettingPaper.RefCN_Name = txtCustomerName.Text;
        //    //Statics.FrmMedicalOrderSettingPaper.ProCreditMoney = Convert.ToDecimal(dt.Rows[0]["Pending"] + "");

        //    Statics.frmMedicalOrderSettingPaper.customerType = customerType;
        ...
        //            Statics.frmMedicalOrderSettingPaper.MS_CodeRef = ms_code;
        //            Statics.frmMedicalOrderSettingPaper.ListOrderRef = dataGridViewSelectList.Rows[dataGridViewSelectList.CurrentRow.Index].Cells["ListOrder"].Value + "";
        ...
        //       Statics.frmMedicalOrderSettingPaper.PRO_CodeGift = PRO_CodeGift;
        ...
        private void Validate_Save(bool IsPopup)
        {
            try
            {
        ...
        private void SaveMedical(bool IsPopup)
        {
            try
            {
                int? intStatus = 0;
                ...
                double SpecialPrice = 0;
                        ...
                        foreach (DataGridViewRow item in dataGridViewSelectList.Rows)//product
                        {
                            ...
                            if (CodeArr.Length > 1)
                            {
                                ...
                                {
                                    supplieInfo = new Entity.SupplieTrans();
                                    supplieInfo.RefVN = txtRefVN.Text;
                                    ...
                                    DataGridViewCheckBoxCell chkCom = item.Cells["chkCanceled"] as DataGridViewCheckBoxCell;
                                    ...
                                    supplieInfo.MOType = item.Cells["Tab"].Value + "";
                            ...
                            else
                            {
                                ...
                                supplieInfo.PriceAfterDis = Convert.ToDecimal(string.IsNullOrEmpty(item.Cells["PriceTotal"].Value + "") ? "0" : item.Cells["PriceTotal"].Value + "");
                                supplieInfo.SpecialPrice = SpecialPrice = item.Cells["SpecialPrice"].Value + ""==""?0:Convert.ToDouble(item.Cells["SpecialPrice"].Value + "");
                                ...
                                supplieInfo.MS_Price =item.Cells["Price/Unit"].Value + ""==""?0: Convert.ToDouble(item.Cells["Price/Unit"].Value + "");
                        ...
                        info.RefVN = txtRefVN.Text;

                        intStatus = new Business.MedicalOrder().InsertMedicalOrderRefVN(info);

                        if (intStatus > 0 && IsPopup)
                        {
                            
                            if (Statics.frmMedicalOrderList != null)
                            {
                                Statics.frmMedicalOrderList.txtSo.Text = txtRefVN.Text;
        ...
        private void FrmMedicalOrderSettingPaper_FormClosing(object sender, FormClosingEventArgs e)
        {
            Statics.frmMedicalOrderSettingPaper = null;
        }
        ...
        private void dataGridViewSelectList_CellMouseUp(object sender, DataGridViewCellMouseEventArgs e)
        {
            try
            {
                ...
                if (e.ColumnIndex == dataGridViewSelectList.Columns["SpecialPrice"].Index || e.ColumnIndex == dataGridViewSelectList.Columns["SpecialPrice"].Index )
                    ISEndEdit = false;    
        ...
        //{
        //    var idMax = AryuwatSystem.Data.UtilityBackEnd.GenMaxSeqnoValues("VN");
        //    txtRefVN.Text = idMax;
        ...
        private void PrintSO()
        {
            try
            {
                ...
                string strTypeofPay = "";
                obj.FormName = "RptMedicalOrderRefVN";
        ...
        private void FrmMedicalOrderSettingPaper_Shown(object sender, EventArgs e)
        {
            try
            {
        ...
        private void PopBenefits()
        {
            try
            {
                ...
                if (!ms_code.ToLower().Contains("atb") && !ms_code.ToLower().Contains("atf") && !Userinfo.IsAdmin.Contains(Userinfo.EN))
                {
                    dataGridViewSelectList.Rows[currentRowIndex].Cells["Free"].Value = "";
                    dataGridViewSelectList.Rows[currentRowIndex].Cells["SpecialPrice"].Value = 0;
                    dataGridViewSelectList.EndEdit();
        ...
        private void dataGridViewSelectList_CellMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            try
            {
                ...
                if (e.ColumnIndex == dataGridViewSelectList.Columns["chkSaleCom"].Index || e.ColumnIndex == dataGridViewSelectList.Columns["chkBydr"].Index )
                {
                    ...
                    {
                        if ((!Userinfo.IsAdmin.Contains(Userinfo.EN) || !Userinfo.IS_ADMIN_JOBCOST.Contains(Userinfo.EN)) && SurgicalFeeNewTab.ToUpper() != "Y" || CN.Contains("CNS") || supplieInfo.MS_Code.Contains("(S)"))// ถ้าธรรมดา ไม่ใช้ติ๊กdataGridViewSelectList.Rows[dataGridViewSelectList.CurrentRow.Index].Cells["Tab"].Value + "".ToUpper() == "PHARMACY"
                        {
                            ch1.Value = "false";
        ...
        private void dataGridViewSelectList_CellMouseDoubleClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            try
            {
                if (e.ColumnIndex == dataGridViewSelectList.Columns["chkSaleCom"].Index || e.ColumnIndex == dataGridViewSelectList.Columns["chkBydr"].Index)
                {
                    ...
                    {
                        if (Userinfo.IsAdmin.Contains(Userinfo.EN) || Userinfo.IS_ADMIN_JOBCOST.Contains(Userinfo.EN))//ถ้า admin  ปกติ
                        {
                            if ((ch1.Value + "").ToLower() == "true")
                                ch1.Value = "false";
                            else
