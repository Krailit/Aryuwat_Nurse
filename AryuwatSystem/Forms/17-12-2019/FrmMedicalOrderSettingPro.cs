...
//    btnSave.Enabled = false; 
                ...
                foreach (DataRow dr in dtSup.Rows)
                {
                    ...
                    //===================ตอนโหลดมา ก็ เช็คและลด 5 %=================================
                        ...
                        object[] myItems = {
                                          ...
                                          CalcDiscountTopUp(NormalPrice,PROPrice1.ToString("###,###,###.##"),ms_name,code),//PROPrice1.ToString("###,###,###.##"),//Special Price
                        ...
                        else //ถ้าเป็น ธรรมดา
                        {
                                    ...
                                    object[] myItems = {
                                               ...
                                               CalcDiscountTopUp(pricePerUnit,dr["SpecialPrice"] + "",dr["MS_Name"] + "",dr["MS_Code"] + ""),//double.Parse(dr["SpecialPrice"] + "").ToString("###,###.##"),//SpecialPrice
                ...
                else
                {
                    ...
                    foreach (DataGridViewRow item in dv.Rows)//ถ้าเลือกรายการแบบทั่วไป ใช้อันนี้
                    {
                        if ((bool)item.Cells[0].Value == true)
                        {
                            ...
                            //{
                            //    MS_PriceDouble = MS_PriceDouble - (MS_PriceDouble * Entity.Userinfo.FIX_COUPON_TOPUP);
                            ...
                            if (Cal_COUPON > 0) dblAmount = Cal_COUPON;
                            ...
                            object[] myItems = {
                                           ...
                                           "0",//Balance
                                          MS_Price,//PricePer
                                          PROCredit=="Y"?CalcDiscount(MS_PriceDouble):CalcDiscountTopUp(MS_PriceDouble,"0",MS_Name, item.Cells["Code"].Value+""),//Special Price
                                          "",
    ...
    private string CalcDiscountTopUp(decimal MS_PriceDouble, string spPrice, string MS_Name, string MSCode)
    {
        string specialDiscount = spPrice;
        try
        {
            if (Entity.Userinfo.FIX_PRO_TOPUP5.Contains(PRO_Code) && !Entity.Userinfo.FIX_COUPON_Wallet.Contains(MSCode) && !MS_Name.ToUpper().Contains(Entity.Userinfo.FIX_Contains_BUFFET))//ไม่ใช่ คูปอง  ไม่ใช่ buffet
            {
                MS_PriceDouble = MS_PriceDouble - (MS_PriceDouble * Entity.Userinfo.FIX_COUPON_TOPUP);
                
                specialDiscount = CalcDiscount(MS_PriceDouble);//.ToString("###,###,###.##");
            }
            //else
            //{
            //    specialDiscount = "0";
    ...
    private void FilterList(DataGridView dgv,DataTable dt,string txtFilter,string tab)
    {
        ...
        private void SumPriceMedicalOrder()
        {
            try
            {
                ...
                else
                {
                    ...
                    {
                        if (PRO_CalType == "P" && ProDiscountPercen>0)
        ...
        private void CallFormRef(Statics.CallMode cMode)
        {
          ...
          //  string PRO_CodeGift = "";
            ...
            Statics.frmMedicalOrderSettingPro.BackColor = Color.FromArgb(170, 232, 229);
        ...
        private void btnChange_Click(object sender, EventArgs e)
        {
            try
            {
                 ...
                 else CallFormRef(Statics.CallMode.Ref);
            }
            catch (Exception ex)
            {
                MessageBox.Show(ex.Message);
